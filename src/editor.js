...
const terminal = (palette) => {
  return {
    'terminal.background': palette.dark.grey3,
    ...
    'terminal.ansiBrightWhite': '#cecece',
    ...
    'terminal.ansiWhite': '#989898',
    'terminal.ansiYellow': palette.primary.yellow,
    'terminal.selectionBackground': `${palette.primary.white}${getHexAlpha(10)}`,
    'terminal.selectionForeground': `${palette.primary.white}${getHexAlpha(80)}`,
